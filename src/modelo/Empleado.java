...
public class Empleado extends Persona{
    ...
    public void agregar(){
        try {
            ...
            JOptionPane.showMessageDialog(null, Integer.toString(executar) + "Ingreso exitoso",
    ...
    public void actualizar() {
        try {
            ...
            JOptionPane.showMessageDialog(null, Integer.toString(executar) + "Actualizacion exitosa",
                  "Mensaje", JOptionPane.INFORMATION_MESSAGE);
        } catch(HeadlessException | SQLException ex) {
            System.out.println("Error: " + ex.getMessage());
        }
    ...
    public void eliminar(){
        try {
            ...
            JOptionPane.showMessageDialog(null,Integer.toString(executar) + "Eliminacion exitosa",
                "Mensaje", JOptionPane.INFORMATION_MESSAGE);
        } catch(HeadlessException | SQLException ex) {
            System.out.println("Error: " + ex.getMessage());
        }
